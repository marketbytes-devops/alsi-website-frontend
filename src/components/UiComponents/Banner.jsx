  ...
  return (
    <div className="relative w-full h-[400px] md:h-[450px] overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.5)), url(${image?.startsWith("http") ? image : `http://194.164.149.249:8000${image}`})`, backgroundPosition:`${backgroundPosition}`, backgroundSize:`${backgroundSize}`, backgroundRepeat:"no-repeat", objectFit:`${objectFit}`
        }}
      ></div>
