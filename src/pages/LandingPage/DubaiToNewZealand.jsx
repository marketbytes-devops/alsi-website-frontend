...
import landingImage from "../../assets/images/Landing/DubaiToNewZealand/banner-dubai-to-new-zealand.webp";
import courierImage from "../../assets/images/Landing/DubaiToNewZealand/courier-dubai-to-new-zealand.webp";
import pickupImg from "../../assets/images/Landing/DubaiToNewZealand/packing-dubai-to-new-zealand.webp";
import deliveryImg from "../../assets/images/Landing/DubaiToNewZealand/delivery-dubai-to-new-zealand.webp";
import expertImg from "../../assets/images/Landing/DubaiToNewZealand/expert-dubai-to-new-zealand.webp";
import handlingImg from "../../assets/images/Landing/DubaiToNewZealand/handling-dubai-to-new-zealand.webp";
import exchangeImg from "../../assets/images/Landing/DubaiToNewZealand/exchange-dubai-to-new-zealand.webp";
import serveImg from "../../assets/images/Landing/DubaiToNewZealand/serve-dubai-to-new-zealand.webp";
import accordianImg from "../../assets/images/Landing/DubaiToNewZealand/accordian-dubai-to-new-zealand.webp";

import dubaiToNewZealandData from "./dubaiToNewZealandData.js";

const DubaiToNewZealand = () => {
  const {
    header,
    services,
    additionalSections,
    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="fixed inset-0 backdrop-brightness-50" onClick={closeModal}></div>
...
export default DubaiToNewZealand;