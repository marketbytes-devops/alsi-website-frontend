...
import landingImage from "../../assets/images/Landing/QatarToHungary/banner-qatar-to-hungary.webp";
import courierImage from "../../assets/images/Landing/QatarToHungary/courier-qatar-to-hungary.webp";
import pickupImg from "../../assets/images/Landing/QatarToHungary/packing-qatar-to-hungary.webp";
import deliveryImg from "../../assets/images/Landing/QatarToHungary/delivery-qatar-to-hungary.webp";
import expertImg from "../../assets/images/Landing/QatarToHungary/expert-qatar-to-hungary.webp";
import handlingImg from "../../assets/images/Landing/QatarToHungary/handling-qatar-to-hungary.webp";
import exchangeImg from "../../assets/images/Landing/QatarToHungary/exchange-qatar-to-hungary.webp";
import serveImg from "../../assets/images/Landing/QatarToHungary/serve-qatar-to-hungary.webp";
import accordianImg from "../../assets/images/Landing/QatarToHungary/accordian-qatar-to-hungary.webp";

import qatarToHungaryData from "./qatarToHungaryData.js";

const QatarToHungary = () => {
  const {
    header,
    services,
    additionalSections,
  ...
  return (
    <>
      ...
      <section className="bg-[#125194] mt-4 sm:mt-4 md:mt-20 lg:mt-20">
        <div className="mx-4 sm:mx-4 md:mx-:mx-28 lg:mx-28 py-4 sm:py-20">
